...
#and two integers target and start, 
#find an index i such that nums[i] == target 
#and abs(i - start) is minimized. 
...
#Output: 1
#Explanation: nums[4] = 5 is the only value 
#equal to target, so the answer is abs(4 - 3) = 1.
